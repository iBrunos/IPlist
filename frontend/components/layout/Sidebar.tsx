  ...
  return (
    ...
    `}>
      ...
      <div className={`flex items-center gap-3 p-4 border-b border-[rgba(0,255,100,0.08)] ${collapsed ? 'justify-center' : ''}`}>
        ...
        {!collapsed && (
          <span className="font-[family-name:var(--font-mono)] text-[8px] text-[rgba(0,255,100,0.4)] tracking-[2px] uppercase">
            v1.0.0
          </span>
        )}
      </div>
        ...
        {navItems.map(item => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={`
                flex items-center gap-3 px-3 py-2.5 transition-all relative group
                ${active
            ...
            >
              ...
              {!collapsed && (
                <span className="font-[family-name:var(--font-mono)] text-[11px] tracking-[2px]">
                  {item.label}
                </span>
              )}
            </Link>
      ...
      <div className={`p-3 border-t border-[rgba(0,255,100,0.08)] space-y-2`}>
        ...
        <button
          ...
          className={`
            w-full flex items-center gap-2 px-3 py-2 text-[rgba(255,100,100,0.5)] 
