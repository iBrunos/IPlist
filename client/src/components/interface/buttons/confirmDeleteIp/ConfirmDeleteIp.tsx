...
interface ConfirmDeleteIpProps {
  confirmDeleteIp: Ip; // Supondo que você tenha uma interface chamada Ip definida em outro lugar
  confirmDelete: () => void; // Função para confirmar a exclusão do IP
  cancelDelete: () => void; // Função para cancelar a exclusão do IP
}

const ConfirmDeleteIp: React.FC<ConfirmDeleteIpProps> = ({ confirmDeleteIp, confirmDelete, cancelDelete }) => {
  return (
    <>
      {confirmDeleteIp && (
...
export default ConfirmDeleteIp;